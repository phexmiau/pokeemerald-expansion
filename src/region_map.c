...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE1] = {MAP_GROUP(MAP_ROUTE1), MAP_NUM(MAP_ROUTE1), HEAL_LOCATION_ROUTE1},
    [MAPSEC_ROUTE2] = {MAP_GROUP(MAP_ROUTE2), MAP_NUM(MAP_ROUTE2), HEAL_LOCATION_ROUTE2},
    [MAPSEC_ROUTE3] = {MAP_GROUP(MAP_ROUTE3), MAP_NUM(MAP_ROUTE3), HEAL_LOCATION_ROUTE3},
    [MAPSEC_ROUTE4] = {MAP_GROUP(MAP_ROUTE4), MAP_NUM(MAP_ROUTE4), HEAL_LOCATION_ROUTE4},
    [MAPSEC_ROUTE5] = {MAP_GROUP(MAP_ROUTE5), MAP_NUM(MAP_ROUTE5), HEAL_LOCATION_ROUTE5},
    [MAPSEC_REGIONAL_VENUE] = {MAP_GROUP(MAP_REGIONAL_VENUE), MAP_NUM(MAP_REGIONAL_VENUE), HEAL_LOCATION_REGIONAL_VENUE},
};
