...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                {EVO_MOVE, MOVE_KNOCK_OFF, SPECIES_SAMUROTT_HISUI}),
    },
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                {EVO_NONE, ITEM_DAWN_STONE, SPECIES_LILLIGANT_HISUI}),
    },
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_BRAVIARY},
                                {EVO_MOVE, MOVE_PSYCHIC, SPECIES_BRAVIARY_HISUI}),
    },
    ...
    [SPECIES_DEINO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_ZWEILOUS}),
    },
    ...
    [SPECIES_ZWEILOUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 47, SPECIES_HYDREIGON}),
    },
