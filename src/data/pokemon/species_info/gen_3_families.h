...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_SHARPNESS, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_VIBRAVA}),
    },
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_WATER_ABSORB, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_PUNK_ROCK, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_MOXIE, ABILITY_HYDRATION },
    #else
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_MALE, ITEM_ICE_STONE, SPECIES_GLALIE},
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_SEALEO}),
    },
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_PINK,
