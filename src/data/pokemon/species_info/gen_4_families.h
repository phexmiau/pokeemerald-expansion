...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_CLEAR_BODY, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_STAR_PIECE, SPECIES_LOPUNNY}),
    },
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CLEAR_BODY, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
