...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DRAGON_SCALE, SPECIES_SLIGGOO},
                                {EVO_LEVEL, 32, SPECIES_SLIGGOO_HISUI}),
    },
    ...
    [SPECIES_SLIGGOO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_RAIN, 44, SPECIES_GOODRA},
                                {EVO_LEVEL_FOG, 44, SPECIES_GOODRA}),
    },
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSliggooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL_RAIN, 44, SPECIES_GOODRA_HISUI},
                                {EVO_LEVEL_FOG, 44, SPECIES_GOODRA_HISUI}),
    },
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_ICE_BODY, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_NOIVERN}),
    },
