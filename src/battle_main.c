...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_BEAUTY] = { _("UNDERDOG"), 20 },
    ...
    [TRAINER_CLASS_CHAMPION] = { _("EXPLORER"), 50 },
    ...
    [TRAINER_CLASS_RIVAL] = { _("WORLD CHAMP"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("SETTLER"), 20, BALL_LUXURY },
    ...
    [TRAINER_CLASS_PIKE_QUEEN] = { _("YOURS,") },
